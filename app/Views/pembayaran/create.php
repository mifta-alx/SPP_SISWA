    ...
    <div class="col-md-12">
      ...
      <div class="card card-outline card-outline-tabs">
        <!-- <div class="card-header">
          <h7 class="card-title">Tambah Data Pembayaran</h7>
        </div> -->
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" method="post" action="<?= base_url('pembayaran/tambah') ?>">
          <?= csrf_field(); ?>
          <div class="card-body">
            <!-- <div class="form-group">
              <label for="id_pembayaran">ID Pembayaran</label>
              <input type="text" class="form-control <?= ($validation->hasError('id_pembayaran')) ? 'is-invalid' : ''; ?>" id="id_pembayaran" placeholder="ID Pembayaran" name="id_pembayaran" value="<?= old('id_pembayaran'); ?>">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="id_pembayaran">ID Pembayaran</label>
                  <input type="text" class="form-control <?= ($validation->hasError('id_pembayaran')) ? 'is-invalid' : ''; ?>" id="id_pembayaran" autocomplete="off"" name="id_pembayaran" value="<?= old('id_pembayaran'); ?>" autofocus>
                  <div class="invalid-feedback">
                    <?= $validation->getError('id_pembayaran'); ?>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input type="hidden" name="nama_petugas" id="nama_petugas" class="form-control" value="<?= old('nama_petugas'); ?>">
                </div>
                <div class="form-group">
                  <label>Nama</label>
                ...
                <div class="form-group">
                  ...
                  <input autocomplete="off" type="hidden" name="nama" id="nama" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" value="<?= old('nama'); ?>" readonly>
                  <input autocomplete="off" type="text" id="nisn2" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" value="<?= old('nisn'); ?>" readonly>
                  <div class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <input autocomplete="off" type="text" class="form-control <?= ($validation->hasError('nama_kelas')) ? 'is-invalid' : ''; ?>" id="nama_kelas" name="nama_kelas" value="<?= old('nama_kelas'); ?>" readonly>
                  <div class="invalid-feedback">
              ...
              <div class="form-group">
                  ...
                  <input autocomplete="off" type="text" class="form-control <?= ($validation->hasError('tgl_bayar')) ? 'is-invalid' : ''; ?>" id="tgl_bayar" name="tgl_bayar" value="<?= old('tgl_bayar'); ?>" readonly>
                  <div class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="tahun_dibayar" name="tahun_dibayar" class="form-control <?= ($validation->hasError('tahun_dibayar')) ? 'is-invalid' : ''; ?>" autocomplete="off" value="<?= old('tahun_dibayar'); ?>" readonly>
                  <div class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="idnespp" class="form-control <?= ($validation->hasError('id_spp')) ? 'is-invalid' : ''; ?>" id="id_spp" autocomplete="off" name="id_spp" value="<?= old('id_spp'); ?>" readonly>
                  <div class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="jumlahDibayar" class="form-control <?= ($validation->hasError('jumlah_bayar')) ? 'is-invalid' : ''; ?>" id="jumlah_bayar" autocomplete="off" name="jumlah_bayar" value="<?= old('jumlah_bayar'); ?>" readonly>
                  <div class="invalid-feedback">

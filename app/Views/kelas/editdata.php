        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-outline-tabs">
                <!-- <div class="card-header">
                    <h7 class="card-title">Edit Data Kelas</h7>
                </div> -->
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?= base_url('kelas/ubahdata/' . $kelas['id_kelas']) ?>">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="<?= old('id_kelas', $kelas['id_kelas']) ?>" autocomplete="off" type="text" class="form-control <?= ($validation->hasError('id_kelas')) ? 'is-invalid' : ''; ?>" id="id_kelas" name="id_kelas" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?= old('nama_kelas', $kelas['nama_kelas']) ?>" autocomplete="off" type="text" class="form-control <?= ($validation->hasError('nama_kelas')) ? 'is-invalid' : ''; ?>" id="nama_kelas" name="nama_kelas">
                                    <div class="invalid-feedback">
                        ...
                        <div class="card-footer px-0">
                            ...
                            <a href="<?= base_url('kelas/index') ?>" type="cancel" name="batal" class="btn btn-danger btn-icon-split">
                                <span class="icon">
                            ...
                            <a href="<?= base_url('kelas/index') ?>" type="cancel" name="batal" class="btn btn-danger"><i class="fa fa-times"></i> Batal</a> -->
                            <!-- </div> -->
                        </div>
                </form>
            </div>
